...
export default function ResoudreForm({
  title = "Faire résoudre un sujet",
  subtitle = "Envoie une photo ou un PDF d'un exercice (n'importe quel sujet) et reçois une correction détaillée, étape par étape, en français.",
}: {
  title?: string;
  subtitle?: string;
}) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <p className="text-center text-slate-600 mb-10">{subtitle}</p>
